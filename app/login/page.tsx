...
import { StoreProvider } from "@/lib/store"; // Wrap to provide context if needed, though mostly for layout
// Note: We're using client-side signIn here for simplicity and immediate feedback
